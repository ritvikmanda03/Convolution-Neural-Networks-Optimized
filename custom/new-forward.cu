...
__global__ void restrict_loopunroll(float* __restrict__ output, const float* __restrict__ input, const float* __restrict__ mask, const int B, const int M, const int C, const int H, const int W, const int K,const int S)
{
    /*
    ...
    */
    ...
    int b = blockIdx.z; // grid z dimension is used for images in batch
    ...
    if(h < H_out && h >= 0 && w < W_out && w >= 0){
        for(int c = 0; c < C; c++){
            ...
            /*
                ...
                acc += in_4d(b, c, h*S + 0, w*S + 5) * mask_4d(m, c, 0, 5);
                acc += in_4d(b, c, h*S + 0, w*S + 6) * mask_4d(m, c, 0, 6);
                acc += in_4d(b, c, h*S + 0, w*S + 7) * mask_4d(m, c, 0, 7);
                ...
                acc += in_4d(b, c, h*S + 1, w*S + 5) * mask_4d(m, c, 1, 5);
                acc += in_4d(b, c, h*S + 1, w*S + 6) * mask_4d(m, c, 1, 6);
                acc += in_4d(b, c, h*S + 1, w*S + 7) * mask_4d(m, c, 1, 7);
                ...
                acc += in_4d(b, c, h*S + 2, w*S + 5) * mask_4d(m, c, 2, 5);
                acc += in_4d(b, c, h*S + 2, w*S + 6) * mask_4d(m, c, 2, 6); 
                acc += in_4d(b, c, h*S + 2, w*S + 7) * mask_4d(m, c, 2, 7);
                ...
                acc += in_4d(b, c, h*S + 3, w*S + 5) * mask_4d(m, c, 3, 5);
                acc += in_4d(b, c, h*S + 3, w*S + 6) * mask_4d(m, c, 3, 6);
                acc += in_4d(b, c, h*S + 3, w*S + 7) * mask_4d(m, c, 3, 7);
                ...
                acc += in_4d(b, c, h*S + 4, w*S + 5) * mask_4d(m, c, 4, 5);
                acc += in_4d(b, c, h*S + 4, w*S + 6) * mask_4d(m, c, 4, 6);
                acc += in_4d(b, c, h*S + 4, w*S + 7) * mask_4d(m, c, 4, 7);
                ...
                acc += in_4d(b, c, h*S + 5, w*S + 5) * mask_4d(m, c, 5, 5);
                acc += in_4d(b, c, h*S + 5, w*S + 6) * mask_4d(m, c, 5, 6);
                acc += in_4d(b, c, h*S + 5, w*S + 7) * mask_4d(m, c, 5, 7);
                ...
                acc += in_4d(b, c, h*S + 6, w*S + 5) * mask_4d(m, c, 6, 5);
                acc += in_4d(b, c, h*S + 6, w*S + 6) * mask_4d(m, c, 6, 6);
                acc += in_4d(b, c, h*S + 6, w*S + 7) * mask_4d(m, c, 6, 7);

                acc += in_4d(b, c, h*S + 7, w*S + 0) * mask_4d(m, c, 7, 0);
                acc += in_4d(b, c, h*S + 7, w*S + 1) * mask_4d(m, c, 7, 1);
                acc += in_4d(b, c, h*S + 7, w*S + 2) * mask_4d(m, c, 7, 2);
                acc += in_4d(b, c, h*S + 7, w*S + 3) * mask_4d(m, c, 7, 3);
                acc += in_4d(b, c, h*S + 7, w*S + 4) * mask_4d(m, c, 7, 4);
                acc += in_4d(b, c, h*S + 7, w*S + 5) * mask_4d(m, c, 7, 5);
                acc += in_4d(b, c, h*S + 7, w*S + 6) * mask_4d(m, c, 7, 6);
                acc += in_4d(b, c, h*S + 7, w*S + 7) * mask_4d(m, c, 7, 7);
            }
            */
            else{
                for(int p = 0; p < K; p++){
...
__global__ void fp16_arithmetic(float *output, const float *input, const float *mask, const int B, const int M, const int C, const int H, const int W, const int K,const int S)
{
    /*
    Modify this function to implement the forward pass described in Chapter 16.
    We have added an additional dimension to the tensors to support an entire mini-batch
...
__host__ void GPUInterface::conv_forward_gpu(float *device_output, const float *device_input, const float *device_mask, const int B, const int M, const int C, const int H, const int W, const int K, const int S)
{
    ...
    // fp16_arithmetic<<<gridDim, blockDim>>>(device_output, device_input, device_mask, B, M, C, H, W, K, S);
    restrict_loopunroll<<<gridDim, blockDim>>>(device_output, device_input, device_mask, B, M, C, H, W, K, S);
}
